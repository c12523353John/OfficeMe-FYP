...
public class VisitorDetailedBookingConfirmation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String requestedBy = getHostName(bookingRequest.getBookingRequestHostID());
        ...
        cancelRequestButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("sms:" + getHostPhone(bookingRequest.getBookingRequestHostID())));
                intent.putExtra("exit_on_sent", true);
                intent.putExtra("sms_body", "Hi " + getHostName(bookingRequest.getBookingRequestHostID()) + ", I won't be able to make the requested time for " + title);
...
//
    ...
    public  void onActivityResult(int reqCode, int resCode, Intent data) {
        ...
        if(reqCode == 1) {
            ...
            Intent i = new Intent(VisitorDetailedBookingConfirmation.this, ViewingInformation.class);
            startActivity(i);
        }
